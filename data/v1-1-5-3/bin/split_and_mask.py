...
file_in = '../v1-1-5-3.hd5'
file_A = "v1-1-5-3.E3.hd5" #training set
file_B = "v1-1-5-3.F3.hd5" #ground truth for scRNA-seq data
file_B_sub = 'v1-1-5-3.F3.msk.hd5' #mimic scRNA_seq data with drop-outs
...
print("E3.shape: ", df_A.shape)
print("F3.shape: ", df_B.shape)
print("F3_msk.shape", df_B_msked.shape)
