...
# One Group (Cell type)
# Just to find a way to make data more variable among cells (change BCV.common to 0.3)
# Lib-size variation disabled to keep things simple
setwd("~/AUDREY_LAB/imputation/simulation/splatter/v1-1-5/")

n_genes = 1000
n_cells = 20000
params <- newSplatParams(nGenes=n_genes, 
                         groupCells=c(n_cells),
                         lib.loc=15, lib.scale=0, 
                         bcv.common=0.75, bcv.df = 60,
