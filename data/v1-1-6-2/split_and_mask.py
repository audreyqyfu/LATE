...
file_in = '../v1-1-5-2.hd5'
file_A = "v1-1-5-2.A.hd5" #training set
file_B = "v1-1-5-2.B.hd5" #ground truth for scRNA-seq data
file_B_sub = 'v1-1-5-2.B.msk.hd5' #mimic scRNA_seq data with drop-outs
