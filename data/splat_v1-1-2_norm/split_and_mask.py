...
file_in = '../splat.OneGroup.norm.hd5'
file_A = "splat.OneGroup.norm.A.hd5" #training set
file_B = "splat.OneGroup.norm.B.hd5" #ground truth for scRNA-seq data
file_B_sub = 'splat.OneGroup.norm.B.mask90.hd5' #mimic scRNA_seq data with drop-outs
