#!/usr/bin/python
# 10/13/2017 test Batch Normalization/BN
...
scale2 = tf.Variable(tf.ones([n_input]))
beta2 = tf.Variable(tf.zeros([n_input]))
...
def encoder(x):
    with tf.name_scope("Encoder"):
        ...
        z1 = tf.matmul(x_drop, encoder_params['w1'])
        ...
        variable_summaries('encoder_scale1', scale1)
        variable_summaries('encoder_beta1', beta1)
