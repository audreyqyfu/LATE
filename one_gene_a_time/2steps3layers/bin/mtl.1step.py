...
# rand init, then run MTL on B.msk90
# to see if MTL on B.msk90 already works
print('output in ./re_train folder')
...
# Rand init rather than restore variables
