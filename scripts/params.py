...
fname_input = os.path.expanduser('~/data/cell_row/example.msk90.hd5')
name_input = 'example.msk90'
ori_input = 'cell_row'  # cell_row/gene_row
transformation_input = 'log10'  # as_is/log10/rpm_log10/exp_rpm_log10

# Output
fname_imputation = os.path.expanduser('./step2/imputation.step2.hd5')  # do not modify for pre-training
...
# Ground Truth
fname_ground_truth = os.path.expanduser('~/data/cell_row/example.hd5')
name_ground_truth = 'GT'
...
# HYPER PARAMETERS
# Model structure
L = 3  # num of layers for Autoencoder, accept: 3/5/7
l = L//2  # inner usage, do not modify
n_hidden_1 = 200  # needed for 3/5/7 layer design
...
# Length of training
max_training_epochs = int(100)  # num_mini_batch / (training_size/batch_size)  todo: change to 100
