...
# PBMC_G949
fname_input = home + '/data/cell_row/pbmc.g949_c40k.msk90.hd5'
name_input = 'pbmc.g949_c40k.msk'
ori_input = 'cell_row'
transformation_input = 'log'  # as_is/log/rpm_log/exp_rpm_log

fname_ground_truth = home + '/data/cell_row/pbmc.g949_c40k.hd5'
name_ground_truth = 'pbmc.g949_c40k'
...
max_training_epochs = int(2e3)  # num_mini_batch / (training_size/batch_size)
display_step = int(50)  # interval on learning curve, 20 displays recommended
snapshot_step = int(1e3)  # interval of saving session, saving imputation
