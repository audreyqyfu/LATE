...
# PBMC_G949 [hd5/csv]
fname_input = home + '/data/cell_row/MBM.MAGIC.9k.B.msk90.hd5'
name_input = 'mbm_magic_msk'
ori_input = 'cell_row'
...
fname_imputation = 'MBM.MAGIC.9k.B.msk90.round.px_rate.csv.gz'  # can be changed
